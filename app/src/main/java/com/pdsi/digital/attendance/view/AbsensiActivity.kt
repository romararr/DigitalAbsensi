...
import com.pdsi.digital.attendance.base.absen.RVAbsenAdapter
...
import com.pdsi.digital.attendance.presenter.AbsensiPresenter
...
class AbsensiActivity : AppCompatActivity(), iAbsensi {
    ...
    private val date = LocalDate.now(ZoneId.of("UTC"))
    private val currentYear = date.year
    private val currentMonth = date.monthValue
    private val currentDay = date.dayOfMonth
